...
export const ALL_PROTOCOLS_2: ProtocolDef[] = [
  ...
  { defId: 'ice', name: '寒冰', set: 'MN02', commands: ['偏转', '守护'], loadingText: '寒锐诡谲' },
  { defId: 'mirror', name: '明镜', set: 'MN02', commands: ['偏转', '复制'], loadingText: '照见本真' },
  { defId: 'peace', name: '和平', set: 'MN02', commands: ['相互弃置', '抽取'], loadingText: '暂得安歇' },
  { defId: 'chaos', name: '混乱', set: 'MN02', commands: ['抽取', '重新排列协议', '被覆盖'], loadingText: '祸福难料' },
  { defId: 'fear', name: '恐惧', set: 'MN02', commands: ['偏转', '强行弃置'], loadingText: '速速退避' },
  { defId: 'clarity', name: '透彻', set: 'MN02', commands: ['抽取', '揭示'], loadingText: '吾道已明' },
  { defId: 'corruption', name: '腐化', set: 'MN02', commands: ['翻转', '强行弃置'], loadingText: '独恶殃众' },
  { defId: 'time', name: '时间', set: 'MN02', commands: ['强行弃置', '使用弃牌堆'], loadingText: '溯往前行' },
  { defId: 'war', name: '战争', set: 'MN02', commands: ['反击', '强行弃置'], loadingText: '鏖战何归' },
  { defId: 'courage', name: '勇气', set: 'MN02', commands: ['抽取', '对比总阈值'], loadingText: '逆焰燎原' },
  { defId: 'luck', name: '幸运', set: 'MN02', commands: ['随机', '删除', '打出'], loadingText: '孤注一掷' },
  { defId: 'smoke', name: '迷雾', set: 'MN02', commands: ['反面打出', '偏转'], loadingText: '弥天障雾' },
...
export const ALL_CARD_DEFS_2: CardDef[] = [
  ...
  { defId: 'smoke-2', protocol: 'smoke', value: 2, top: '此链路中，每有1张牌正面朝下的卡牌，总阈值就加1。' },
  ...
  { defId: 'war-2', protocol: 'war', value: 2, middle: '翻转1张牌。', bottom: '当对手编译后：它弃置所有手牌。' },
  ...
  { defId: 'courage-6', protocol: 'courage', value: 6, top: '回合结束：若此链路中对手总阈值更大，翻转此牌。' },
