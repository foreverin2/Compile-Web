 ...
 *  全链最大点数值 M：估值方（owner）堆叠中点数值 == M 的牌从该玩家 total 扣除（含被盖/反面；多张同 M 全扣）。 */
...
/** 某线双方堆叠中所有 faceUp 卡（含被盖，B2）快照候选 */
 ...
 *  卡数（该线双方堆叠总数）最多；并列 → 拥有者选 1 条（B10）→ 该线全部 faceUp（含被盖，B2）快照逐张翻面。 */
